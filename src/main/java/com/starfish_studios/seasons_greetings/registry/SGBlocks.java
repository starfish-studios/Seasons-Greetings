...
public class SGBlocks {
    ...
    public static final Block GINGERBREAD_TRAPDOOR = registerBlock("gingerbread_trapdoor", new TrapDoorBlock(BlockSetType.OAK, gingerbreadProperties.noOcclusion().pushReaction(PushReaction.DESTROY)));
